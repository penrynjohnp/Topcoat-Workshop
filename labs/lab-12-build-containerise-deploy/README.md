...
- **`topcoat build` is unknown.** As in Lab 11, CLI 0.8.1 has no such command; the Dockerfile uses `cargo build --release` followed by `topcoat asset bundle --release`, matching profiles.
