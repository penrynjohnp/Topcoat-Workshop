...
The routing and view descriptions here follow the pinned v0.8.1 [getting started
guide](https://raw.githubusercontent.com/tokio-rs/topcoat/v0.8.1/crates/topcoat/docs/getting_started.md)
and the release README. The request-context and app-context sections follow the v0.8.1 [app context
guide](https://raw.githubusercontent.com/tokio-rs/topcoat/v0.8.1/crates/topcoat/docs/app_context.md)
and [functions, not middlewares
guide](https://raw.githubusercontent.com/tokio-rs/topcoat/v0.8.1/crates/topcoat/docs/functions_not_middlewares.md).
