...
// ANCHOR: owned-card-style
const CARD: StaticClass = class!(
    "relative overflow-hidden flex flex-col gap-5 rounded-2xl border border-cyan-900/10 \
     bg-white/85 py-6 text-foreground shadow-sm backdrop-blur-sm \
     before:absolute before:inset-x-0 before:top-0 before:h-1 before:bg-gradient-to-r \
     before:from-cyan-500 before:via-sky-400 before:to-blue-600",
);
// ANCHOR_END: owned-card-style
