...
- Versions are pinned in `COMPATIBILITY.md`. The API surface changes between minor versions — check https://docs.rs/topcoat for the pinned version before writing code, and prefer the upstream docs under `crates/*/docs/` in tokio-rs/topcoat.
