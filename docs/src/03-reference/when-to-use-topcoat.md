...
workshop remain pinned to v0.8.1 even when a newer release exists.
...
Sources for the rendering models are the [Topcoat v0.8.1
README](https://github.com/tokio-rs/topcoat/blob/v0.8.1/README.md), [Axum crate
...
|---|---|---|---|
| **Topcoat** | Maintained as a [`tokio-rs` project](https://github.com/tokio-rs/topcoat), announced on the [Tokio site](https://tokio.rs/blog/2026-07-22-announcing-topcoat). | **22 July 2026:** first public announcement. The v0.8.1 README describes the project as early-stage and experimental, with breaking changes expected. | Its [published roadmap](https://github.com/tokio-rs/topcoat/blob/v0.8.1/README.md#roadmap) lists more reactivity, Topcoat UI, Toasty integration, validation, authentication, static export, deployment documentation, and other full-stack facilities. |
