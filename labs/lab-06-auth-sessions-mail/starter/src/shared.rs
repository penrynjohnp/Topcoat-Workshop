...
// TODO(lab-06): add an auth AppState with session records, magic-link records, and cookie keys.
// TODO(lab-06): add `current_user(cx)`, `require_auth(cx)`, and session lifecycle helpers.
// helper that increments the app-scoped counter before calling find_berth.
